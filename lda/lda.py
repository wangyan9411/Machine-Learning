...
class Model(object):
    def __init__(self, dset):
        ...
        self.Z = []        # M*doc.size()，文档中词的主题分布，margin out word or topic？
        self.nw = []       # V*K，词i在主题j上的分布
        self.nwsum = []    # K，属于主题i的总词数，计算主题的后验概率
        self.nd = []       # M*K，文章i属于主题j的词个数, 计算文章主题分布的后验概率
        self.ndsum = []    # M，文章i的词个数
        self.theta = []    # 文档-主题分布，狄利克雷分布的先验分布？
        self.phi = []      # 主题-词分布
